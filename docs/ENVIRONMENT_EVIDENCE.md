...
| SQL behavior | `NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION`; REPEATABLE-READ; server default latin1/swedish, while NexaStock databases/connections explicitly use utf8mb4/utf8mb4_bin and UTC |
